...
class Testhtmlnode(unittest.TestCase):
    ...
    def test_empty_value(self): #TEST EQUAL EMPTY VALUE
        node = HTMLNode("<p>", None, (HTMLNode("<h3>", "ooooo smol node", None, {"href": "https://www.google.com", "target": "_blank"})), {"href": "https://www.google.com", "target": "_blank"} )
        node2 = HTMLNode("<p>", None, (HTMLNode("<h3>", "ooooo smol node", None, {"href": "https://www.google.com", "target": "_blank"})), {"href": "https://www.google.com", "target": "_blank"} )

        self.assertEqual(node, node2)

    
    def test_empty_tag(self): #TEST EQUAL EMPTY TAG
        node = HTMLNode(None, "This is my value (:", (HTMLNode("<h3>", "ooooo smol node", None, {"href": "https://www.google.com", "target": "_blank"})), {"href": "https://www.google.com", "target": "_blank"} )
        node2 = HTMLNode(None, "This is my value (:", (HTMLNode("<h3>", "ooooo smol node", None, {"href": "https://www.google.com", "target": "_blank"})), {"href": "https://www.google.com", "target": "_blank"} )

        self.assertEqual(node, node2)

        
    def test_empty_tag(self): #TEST EQUAL EMPTY CHILD
        node = HTMLNode("<p>", "This is my value (:",None, {"href": "https://www.google.com", "target": "_blank"} )
        node2 = HTMLNode("<p>," "This is my value (:",None, {"href": "https://www.google.com", "target": "_blank"} )

        self.assertEqual(node, node2)

        
    def test_empty_tag(self): #TEST EQUAL EMPTY LINK
        node = HTMLNode("<p>", "This is my value (:", (HTMLNode("<h3>", "ooooo smol node", None, {"href": "https://www.google.com", "target": "_blank"})), None )
        node2 = HTMLNode("<p>", "This is my value (:", (HTMLNode("<h3>", "ooooo smol node", None, {"href": "https://www.google.com", "target": "_blank"})), None )
...
if __name__ == "__main__":
    ...
    # keeping these safe down here, don't forget to overload the operator you goose
